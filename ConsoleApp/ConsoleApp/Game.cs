...
namespace ConsoleApp
{
    class Game
    {
        ...
        {
            //сделать таблицу в виде двумерного массива, 2 столбца будет - имя и рейтинг, размерность [кол-во игроков][2], надо ввести для этого счётчик количества игроков
            //инициализация массива
            // вывести текстом Имя и рейтинг 
            //можно сделать втупую, создать в методе в классе Дата массив и заполнить его рейтингами всех игроков, потом отсортировать его
